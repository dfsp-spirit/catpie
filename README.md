...
[Tested and proven to work](https://github.com/dfsp-spirit/catpie/actions/workflows/ci.yml) on Python 3.9, 3.10, 3.11, 3.12, and 3.13, so it seamlessly integrates into complex setups and does not clash with version restrictions on Python, scipy, numpy, etc of other packages you may be wanting to use it with (yes, we're looking at you, psychopy).
